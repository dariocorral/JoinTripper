//
//  AirportsDepartureViewController.swift
//  JoinTripper
//
//  Created by Dario Corral on 10/10/18.
...
class AirportsDepartureViewController: UITableViewController, CLLocationManagerDelegate {
    ...
    weak var delegate: DepartureAirportForDataEnteredDelegate?
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let cell = tableView.cellForRow(at: indexPath) as? AirportsCell {
            ...
            if let text = cell.code?.text, let detailText = cell.name?.text {
                ...
                print("Airport Departure selected: \(text) \(detailText)")
                ...
                delegate?.userDidEnterDepartureAirportRequestInfo(airport: textToShow)
           }
        }
    }
}
...
extension AirportsDepartureViewController: UISearchResultsUpdating {
