...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CircleLabel/CircleLabel.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TJBioAuthentication/TJBioAuthentication.framework"
